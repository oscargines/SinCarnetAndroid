 ...
 * @param onDocumentosComplementariosClick Navega a documentos complementarios
...
fun CasesScreen(
    ...
    onDocumentosComplementariosClick: () -> Unit = {},
    onCourtsClick: () -> Unit = {},
    onAboutClick: () -> Unit = {}
) {
        ...
        Row(
            ...
            Column(
                ...
                Button(
                    ...
                    Text(
                        text = stringResource(R.string.courts_action)
                    )
                }

                Button(
                    onClick = onDocumentosComplementariosClick,
                    modifier = Modifier.fillMaxWidth(),
                    shape = MaterialTheme.shapes.medium,
                    colors = ButtonDefaults.buttonColors(
                        containerColor = Color(0xFF40407A),
                    ...
                    Text(
                        text = stringResource(R.string.case_documentos_complementarios)
                    )
                }
            }
...
fun CasesScreenPreview() {
    SinCarnetTheme {
        CasesScreen(
            ...
            onSpecialCasesClick = {},
            onDocumentosComplementariosClick = {}
        )
    }
}

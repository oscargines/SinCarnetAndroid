...
import com.oscar.sincarnet.data.toMessageRes
import com.oscar.sincarnet.domain.decision.DrivingMoment
import com.oscar.sincarnet.domain.decision.JudicialBorderBehavior
import com.oscar.sincarnet.domain.decision.JudicialSuspensionDecision
import com.oscar.sincarnet.domain.decision.SentenceType
import com.oscar.sincarnet.domain.decision.resolveJudicialSuspensionDecision
    ...
    Column(
        ...
        PerdidaVigenciaFuntionCard(
            modifier = Modifier
                .fillMaxWidth()
                .weight(1f),
            messageText = decision.messageKey.toMessageRes()?.let { stringResource(it) },

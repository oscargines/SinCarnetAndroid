...
@Composable
fun SolicitudCustodiaJuzgadoFirmasScreen(
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.scj_firmas_title),
                ...
                Button(
                    ...
                    Text(
                        stringResource(
                            if (agenteSigned) R.string.scj_firma_agente_done
                            else R.string.scj_firma_agente
                        )
                    )
                }
                ...
                Button(
                    ...
                    Text(stringResource(R.string.scj_generate))
                }
            }
        }
...
@Composable
private fun SolicitudCustodiaJuzgadoFirmasScreenPreview() {
    SinCarnetTheme {

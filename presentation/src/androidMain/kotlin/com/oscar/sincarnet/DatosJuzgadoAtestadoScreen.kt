...
import com.oscar.sincarnet.data.datasource.loadJuzgadoCcaaFromDatabase
import com.oscar.sincarnet.data.datasource.loadJuzgadoMunicipiosFromDatabase
import com.oscar.sincarnet.data.datasource.loadJuzgadoProvinciasFromDatabase
import com.oscar.sincarnet.data.datasource.loadJuzgadoSedesFromDatabase
import com.oscar.sincarnet.data.datasource.loadPreviewJuzgadoCcaa
import com.oscar.sincarnet.data.datasource.loadPreviewJuzgadoMunicipios
import com.oscar.sincarnet.data.datasource.loadPreviewJuzgadoProvincias
import com.oscar.sincarnet.data.datasource.loadPreviewJuzgadoSedes
...
fun DatosJuzgadoAtestadoScreen(
    ...
    val storage = remember(context) { JuzgadoAtestadoStorage(context.toStorage("juzgado_atestado_storage")) }
    val initialData = remember(isInPreview) {
        if (isInPreview) {
            JuzgadoAtestadoData(
                ...
                sedeId = 1,
                sedeNombre = "Sección de Instrucción del Tribunal de Instancia nº 1 de Oviedo",

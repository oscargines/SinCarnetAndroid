...
private val OCS_DOC_DATE_FORMATTER: DateTimeFormatter = DateTimeFormatter.ofPattern("dd-MM-yyyy")

private fun Long.toOcsDocFormattedDate(): String =
    Instant.ofEpochMilli(this)
        .atZone(ZoneId.systemDefault())
        .toLocalDate()
        .format(OCS_DOC_DATE_FORMATTER)

private fun String.toOcsDocDateMillisOrNull(): Long? = runCatching {
    LocalDate.parse(this, OCS_DOC_DATE_FORMATTER)
...
@Composable
fun OficioCustodiaSangreDocScreen(
    ...
    var juzgadoCompetente by rememberSaveable { mutableStateOf(initialData.juzgadoCompetente) }
    ...
    fun buildCurrentData() = OficioCustodiaSangreData(
        ...
        centroDestinatario = initialData.centroDestinatario,
        ...
        juzgadoCompetente = juzgadoCompetente,
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.ocs_doc_title),
                    style = MaterialTheme.typography.titleMedium
                )

                SectionTitle(text = stringResource(R.string.ocs_nombre_apellidos))
                OutlinedTextField(
                    value = nombreApellidos,
                    onValueChange = { nombreApellidos = it.uppercase() },
                    label = { Text(stringResource(R.string.ocs_nombre_apellidos)) },
                ...
                Row(
                    ...
                    OutlinedTextField(
                        ...
                        singleLine = true,
                        label = { Text(stringResource(R.string.ocs_numero_documento)) }
                    )
                    if (nfcHelper != null) {
                        IconButton(
                ...
                SectionTitle(text = stringResource(R.string.ocs_fecha_hora_siniestro))
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.spacedBy(8.dp),
                    verticalAlignment = Alignment.Top
                    ...
                    OutlinedTextField(
                        ...
                        modifier = Modifier.weight(1f),
                        singleLine = true,
                        label = { Text(stringResource(R.string.ocs_fecha_hora_siniestro)) },
                ...
                Spacer(modifier = Modifier.height(4.dp))
                SectionTitle(text = stringResource(R.string.ocs_carretera))
                OutlinedTextField(
                    value = carretera,
                    onValueChange = { carretera = it.uppercase() },
                    label = { Text(stringResource(R.string.ocs_carretera)) },
                    modifier = Modifier.fillMaxWidth(),
                    singleLine = true
                )
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.ocs_punto_kilometrico)) },
                    modifier = Modifier.fillMaxWidth(),
                    singleLine = true
                )
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.ocs_municipio)) },
                    modifier = Modifier.fillMaxWidth(),
                    singleLine = true
                )
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.ocs_partido_judicial)) },
                    modifier = Modifier.fillMaxWidth(),
                    singleLine = true
                )

                Spacer(modifier = Modifier.height(4.dp))
                SectionTitle(text = stringResource(R.string.ocs_catalogacion_hecho))
                OutlinedTextField(
                    value = catalogacionHecho,
                    onValueChange = { catalogacionHecho = it.uppercase() },
                    label = { Text(stringResource(R.string.ocs_catalogacion_hecho)) },
                    modifier = Modifier.fillMaxWidth()
                )

                Spacer(modifier = Modifier.height(4.dp))
                SectionTitle(text = stringResource(R.string.ocs_juzgado_competente))
                OutlinedTextField(
                    value = juzgadoCompetente,
                    onValueChange = { juzgadoCompetente = it.uppercase() },
                    label = { Text(stringResource(R.string.ocs_juzgado_competente)) },
                    modifier = Modifier.fillMaxWidth(),
                    singleLine = true
                )
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.ocs_numero_diligencia)) },
                    modifier = Modifier.fillMaxWidth(),
                    singleLine = true
                )
    ...
    if (showSiniestroDatePicker) {
        val datePickerState = rememberDatePickerState(
            initialSelectedDateMillis = fechaHoraSiniestro.take(10).toOcsDocDateMillisOrNull()
        )
        DatePickerDialog(
            onDismissRequest = { showSiniestroDatePicker = false },
            confirmButton = {
                TextButton(onClick = {
                    datePickerState.selectedDateMillis?.toOcsDocFormattedDate()?.let {
...
@Composable
private fun OficioCustodiaSangreDocScreenPreview() {
    SinCarnetTheme {

...
import com.oscar.sincarnet.domain.decision.BorderBehavior
import com.oscar.sincarnet.domain.decision.ExpiredValidityDecision
import com.oscar.sincarnet.domain.decision.resolveExpiredValidityDecision
...
fun ExpiredValidityScreen(
    ...
    val lowerCardMessage = decision.messageKey.toMessageRes()?.let { stringResource(it) }

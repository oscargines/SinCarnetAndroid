...
data class ManifestacionDocument(
    val titulo: String = "",
...
data class ManifestacionOption(
    val id: Int,
    val texto: String
)

data class ManifestacionAnexo(
    val id: String,
    val texto: String
)

data class ManifestacionQuestion(
    val id: Int,
    val pregunta: String,
    val campoVariable: String = ""
)

fun loadManifestacionDocument(context: Context): ManifestacionDocument {
    return runCatching {

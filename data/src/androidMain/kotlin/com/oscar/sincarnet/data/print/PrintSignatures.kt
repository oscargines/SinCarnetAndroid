...
data class PrintSignatures(
    ...
    // Acta de traslado de vehículo
    val agenteSignature: ImageBitmap? = null,
    val titularSignature: ImageBitmap? = null,
    val isTraslado: Boolean = false,
    // Acta de traslado a centro sanitario
    val interesado: ImageBitmap? = null,
    val facultativo: ImageBitmap? = null,
    val sanitario: ImageBitmap? = null,
    val agente: ImageBitmap? = null,
    val isCentroSanitario: Boolean = false
)
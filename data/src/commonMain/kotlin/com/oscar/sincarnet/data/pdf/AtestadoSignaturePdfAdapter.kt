 ...
 */
const val SIGNER_INSTRUCTOR = "instructor"
const val SIGNER_SECRETARY = "secretary"
const val SIGNER_INVESTIGATED = "investigated"
const val SIGNER_SECOND_DRIVER = "second_driver"
const val NO_DESEA_FIRMAR_TEXT = "NO DESEA FIRMAR"
 ...
 */
sealed interface PdfSignatureContent<out T> {
    /**
 ...
 */
data class CapturedSignatures<T>(
    val instructor: T?,
    val secretary: T?,
    val investigated: T?,
    val secondDriver: T?
 ...
 */
fun <T> CapturedSignatures<T>.toPdfSlotMap(): Map<PdfSignatureSlot, T> {
 ...
 */
fun <T> mapSignaturesForPdf(signaturesBySigner: Map<String, T>): Map<PdfSignatureSlot, T> {
